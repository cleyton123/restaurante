...
DROP TABLE IF EXISTS `tb_tipo_prato`;
...
LOCK TABLES `tb_tipo_prato` WRITE;

UNLOCK TABLES;



DROP TABLE IF EXISTS `tb_prato`;
...
DROP TABLE IF EXISTS `tb_situacao_pedido`;
...
LOCK TABLES `tb_situacao_pedido` WRITE;
